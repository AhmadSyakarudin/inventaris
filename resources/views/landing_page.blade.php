    ...
    <div class="container text-center py-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 text-center h-100">
                    <div class="card-body p-0">
                        <div class="box-img bg-dark-blue d-flex align-items-center justify-content-center rounded-3 mb-3">
                            <img src="{{ asset('assets/img/1.png') }}" class="img-fluid" alt="Inventory" style="width: 150px">
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 text-center h-100">
                    <div class="card-body p-0">
                        <div class="box-img bg-warning-custom d-flex align-items-center justify-content-center rounded-3 mb-3">
                            <img src="{{ asset('assets/img/2.png') }}" class="img-fluid" alt="Inventory" style="width: 150px">
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 text-center h-100">
                    <div class="card-body p-0">
                        <div class="box-img bg-soft-blue d-flex align-items-center justify-content-center rounded-3 mb-3">
                            <img src="{{ asset('assets/img/3.png') }}" class="img-fluid" alt="Inventory" style="width: 150px">
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 text-center h-100">
                    <div class="card-body p-0">
                        <div class="box-img bg-success d-flex align-items-center justify-content-center rounded-3 mb-3">
                            <img src="{{ asset('assets/img/4.png') }}" class="img-fluid" alt="Borrow" style="width: 150px">
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="{{ asset('assets/img/logo.png') }}" alt="Logo Wikrama" class="mb-3" style="width: 50px;">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#" class="text-danger text-decoration-none">Privacy policy</a></li>
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Cookie Policy</a></li>
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Discover</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="https://linkedin.com" target="_blank" class="text-dark"><i class="bi bi-linkedin"></i></a>
                </div>
            </div>
        </div>
    </div>
